...
# ---------------------------------------------------------------------------
"""
Methods for loading MNIST Fashion dataset for classification, reconstruction, and anomaly detection.
"""
# ---------------------------------------------------------------------------
...
class FMNIST_Basic():
    """Basic MNIST Fashion dataset setup for classification.
    ...
    def __init__(self,validationSplit=0.10):
        (x_learn, y_learn), (x_test, y_test) = tf.keras.datasets.fashion_mnist.load_data()
        ...
        self.trainData = {
            ...
            "label":lab_train.astype(np.int32),
        }
        self.validationData = {
...
class FMNIST_RECON():
    """Basic MNIST Fashion dataset setup for reconstruction.
    Data is split into 3 partitions: training, validation, and testing.
...
class FMNIST_Anomaly():
    """Basic MNIST Fashion dataset setup for anomaly detection.
